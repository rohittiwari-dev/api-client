          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <EnvironmentVariableInput
                value={data.realm || ""}
                onChange={(val) =>
                  handleAuthDataChange({ ...data, realm: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
            ...
            <div>
              ...
              <EnvironmentVariableInput
                value={data.nonce || ""}
                onChange={(val) =>
                  handleAuthDataChange({ ...data, nonce: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
                placeholder="From server response"
              />
            ...
            <div>
              ...
              <EnvironmentVariableInput
                value={data.opaque || ""}
                onChange={(val) =>
                  handleAuthDataChange({ ...data, opaque: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
                placeholder="From server response"
              />
        ...
        <div className="flex items-center space-x-2 pt-2 border-t border-border/40">
          <Switch
            ...
            onCheckedChange={(checked) =>
              handleAuthDataChange({ ...data, disableRetryRequest: checked })
            }
          />
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div>
            ...
            <EnvironmentVariableInput
              ...
              onChange={(val) =>
                handleAuthDataChange({ ...data, consumerKey: val })
              }
              className="bg-muted/30 h-7 text-xs font-mono px-2"
          ...
          <div>
            ...
            <EnvironmentVariableInput
              ...
              onChange={(val) =>
                handleAuthDataChange({ ...data, consumerSecret: val })
              }
              className="bg-muted/30 h-7 text-xs font-mono px-2"
          ...
          <div>
            ...
            <EnvironmentVariableInput
              ...
              onChange={(val) =>
                handleAuthDataChange({ ...data, tokenSecret: val })
              }
              className="bg-muted/30 h-7 text-xs font-mono px-2"
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <EnvironmentVariableInput
                ...
                onChange={(val) =>
                  handleAuthDataChange({ ...data, version: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
                placeholder="1.0"
              />
        ...
        <div className="flex flex-col gap-2 pt-2 border-t border-border/40">
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) =>
                handleAuthDataChange({ ...data, includeBodyHash: checked })
              }
            />
            <Label htmlFor="include-body-hash" className="text-xs font-medium">
              Include Body Hash
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="empty-params" className="text-xs font-medium">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <EnvironmentVariableInput
                ...
                onChange={(val) =>
                  handleAuthDataChange({ ...data, redirectUrl: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
            ...
            <div>
              ...
              <EnvironmentVariableInput
                ...
                onChange={(val) =>
                  handleAuthDataChange({ ...data, authorizationUrl: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
            ...
            <div>
              ...
              <EnvironmentVariableInput
                ...
                onChange={(val) =>
                  handleAuthDataChange({ ...data, accessTokenUrl: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
            ...
            <div>
              ...
              <EnvironmentVariableInput
                value={data.clientId || ""}
                onChange={(val) =>
                  handleAuthDataChange({ ...data, clientId: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
            ...
            <div>
              ...
              <EnvironmentVariableInput
                ...
                onChange={(val) =>
                  handleAuthDataChange({ ...data, clientSecret: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
            ...
            <div>
              ...
              <EnvironmentVariableInput
                value={data.scope || ""}
                onChange={(val) =>
                  handleAuthDataChange({ ...data, scope: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
            ...
            <div>
              ...
              <EnvironmentVariableInput
                value={data.state || ""}
                onChange={(val) =>
                  handleAuthDataChange({ ...data, state: val })
                }
                className="bg-muted/30 h-7 text-xs font-mono px-2"
