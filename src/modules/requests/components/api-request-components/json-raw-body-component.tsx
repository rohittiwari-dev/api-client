	...
	return (
		<div className="flex flex-col gap-2 flex-1 min-h-0 relative">
			<link
				rel="stylesheet"
				href={
					resolvedTheme === "dark" ? 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.11.1/styles/tokyo-night-dark.min.css' : 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.11.1/styles/intellij-light.min.css'
				}
					...
					<TooltipProvider>
						<Tooltip>
							...
							<TooltipContent side="bottom" className="text-xs">
								...
								<p className="text-[10px] text-muted-foreground">Format JSON with indentation</p>
							</TooltipContent>
						</Tooltip>
					</TooltipProvider>
					<TooltipProvider>
						<Tooltip>
							...
							<TooltipContent side="bottom" className="text-xs">
								...
								<p className="text-[10px] text-muted-foreground">Remove whitespace from JSON</p>
							</TooltipContent>
						</Tooltip>
					</TooltipProvider>
				</div>
			...
			<div className="relative flex-1 min-h-0 overflow-auto">
				<Editor
					...
					style={{
						...
						border: error
							? resolvedTheme === 'dark' ? '0.5px solid #961838ff' : '0.5px solid #f18199ff'
							: resolvedTheme === 'dark' ? '0.5px solid #202327ff' : '0.5px solid #dee6f0ff',
						borderRadius: '6px',
						minHeight: '100%',
					}}
