...
const bodyTypes = [
	...
	{ value: BodyType.X_WWW_FORM_URLENCODED, label: 'URL Encoded', icon: FormInput },
	...
	return (
		...
		>
			...
			<div className="flex-1 min-h-0 overflow-auto">
				{/* None - Empty State */}
				<TabsContent value={BodyType.NONE} className="h-full mt-0 data-[state=active]:flex flex-col">
					<div className="flex-1 flex flex-col items-center justify-center gap-4 py-16">
						...
						<div className="text-center space-y-1">
							<p className="text-sm font-medium text-muted-foreground">No Body</p>
				...
				{/* JSON Body */}
				<TabsContent value={BodyType.JSON} className="h-full min-h-0 mt-0 data-[state=active]:flex flex-col overflow-auto">
				...
				{/* Form Data */}
				<TabsContent value={BodyType.FORM_DATA} className="h-full mt-0 data-[state=active]:flex flex-col">
					<FormDataComponent type="FORM_DATA" />
				</TabsContent>

				{/* URL Encoded */}
				<TabsContent value={BodyType.X_WWW_FORM_URLENCODED} className="h-full mt-0 data-[state=active]:flex flex-col">
					<FormDataComponent type="X-WWW-FORM-URLENCODED" />
				</TabsContent>

				{/* Raw Body */}
				<TabsContent value={BodyType.RAW} className="h-full min-h-0 mt-0 data-[state=active]:flex flex-col overflow-auto">
					<JsonAndRawBodyComponent
						type="raw"
