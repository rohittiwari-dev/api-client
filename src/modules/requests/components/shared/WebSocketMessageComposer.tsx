            ...
            <div className={cn('flex flex-col h-full min-h-0 gap-3', className)}>
                        ...
                        <div className="flex items-center gap-1">
                            <TooltipProvider>
                                <Tooltip>
                                    ...
                                    <TooltipContent side="top" className="text-[10px]">Prettify</TooltipContent>
                                </Tooltip>
                            </TooltipProvider>
                            ...
                            <TooltipProvider>
                                <Tooltip>
                                    ...
                                    <TooltipContent side="top" className="text-[10px]">Minify</TooltipContent>
                                </Tooltip>
                            </TooltipProvider>
                        </div>
                    )}
                    ...
                    <div className={cn(
                        ...
                        <Editor
                            ...
                            style={{
                                ...
                                border: jsonError
                                    ? resolvedTheme === 'dark' ? '1px solid #961838ff' : '1px solid #f18199ff'
                                    : resolvedTheme === 'dark' ? '1px solid #202327ff' : '1px solid #dee6f0ff',
                                borderRadius: '8px',
                                height: '100%',
                                minHeight: '100%',
                            }}
                            textareaClassName="focus:outline-none resize-none !text-xs !bg-transparent"
                            preClassName={format === 'json' ? "language-json !text-xs" : "!text-xs"}
                ...
                <div className="flex items-center justify-between gap-2 shrink-0 pt-1">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button
                            onClick={handleSend}
                            disabled={disabled || !value.trim() || (format === 'json' && !!jsonError)}
                            size="sm"
                ...
                <DialogContent className="sm:max-w-[440px] gap-0 p-0 overflow-hidden border-violet-500/20 shadow-2xl shadow-violet-500/10">
                    ...
                    <div className="p-4 space-y-4">
                        <div className="space-y-1.5">
                            <Label htmlFor="messageName" className="text-xs font-semibold text-foreground/80">
                                Message Name
                            </Label>
                            <Input
                                id="messageName"
                        ...
                        <div className="space-y-1.5">
                            <span className="text-xs font-semibold text-foreground/80">Preview Content</span>
                            <div className={cn(
                                ...
                                <div className="h-[120px] w-full relative">
                                    <Editor
                                        ...
                                        preClassName={format === 'json' ? "language-json !bg-transparent" : "!bg-transparent"}
                                        disabled
                                    />
                                    {!value && (
