import { getAllCollections } from "@/modules/apis/collections/server/collection.action";
import {
  SidebarCollectionItemInterface,
  SidebarItemInterface,
} from "../store/sidebar.store";
import { NestedCollection } from "@/modules/apis/collections/types/sidebar.types";
import { RequestType } from "@/modules/apis/requests/types/store.types";
import { getAllIndependentRequests } from "@/modules/apis/requests/server/request";
