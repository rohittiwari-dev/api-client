    ...
    return (
        <Collapsible
            className={cn(
                ...
                isOver && dropPosition === "inside" && "bg-primary/10 border border-primary/20 ring-1 ring-primary/30"
            )}
            open={isOpen}
        ...
        >
            <CollapsibleTrigger asChild>
                ...
                >
                    ...
                    <div data-actions="true" className="opacity-0 transition-opacity ml-auto">
