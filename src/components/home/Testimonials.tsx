...
const testimonials = [
    {
        ...
        company: 'TechCorp',
        avatar: 'SC',
        content: "ApiClient has completely transformed how I test APIs. The WebSocket support is incredible, and the UI is so much cleaner than other tools I've used.",
    ...
    },
    {
        ...
        company: 'StartupXYZ',
        avatar: 'MJ',
        content: 'Finally, an API client that looks as good as it works. The collections feature saves me hours every week. Highly recommended!',
    ...
    },
    {
        ...
        company: 'CloudScale',
        avatar: 'ER',
        content: 'The environment switching is seamless. I can test across dev, staging, and prod without any hassle. Game changer for our team.',
    ...
    },
    {
        ...
        company: 'DataFlow',
        avatar: 'AK',
        content: "Been using this for GraphQL development and it's perfect. The query builder and response visualization are top-notch.",
    ...
    },
    {
        ...
        avatar: 'JT',
        content: 'Our entire team switched to ApiClient. The collaboration features and shared collections make API development so much smoother.',
    ...
    },
    {
        ...
        company: 'BuildRight',
        avatar: 'PP',
        content: 'The code generation feature alone is worth it. Export to any language in seconds. Beautiful interface too!',
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-pink-300">Loved by Developers</span>
                    </motion.div>
